...
public class DataActions {
	...
	public static class AddToDataSet extends ITimedAutomata.StateAdapter<INode> {
		@Override
	...
	public static class AddToForwardedSet extends ITimedAutomata.StateAdapter<INode> {
		@Override
		public void postAction(INode context, String key) {
