...
public abstract class TimedAutomata<C> {
	int _current;
	int _currentTimeout;
	...
	public TimedAutomata(Action<C>[] states, Predicate<C>[] predicates, int initial, int[][] transitionsPredicates, int[] timeouts, int[][] transitionsTarget, int[] timeoutsTarget) {
		_states = states;
	...
	public TimedAutomata(Action<C>[] states, Predicate<C>[] predicates, Action<C> initial, int[][] transitionsPredicates, int[] timeouts, int[][] transitionsTarget, int[] timeoutsTarget) {
	...
	final public Predicate<C>[] getPreicates() {
		return _predicates;
	}
	...
	public static class DelegatedTimedAutomata<C> extends TimedAutomata<C> {
